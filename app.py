...
METRIC_ICON_SVGS = {
    ...
    "oil_barrel": '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 3h10l1.5 3.2v11.6L17 21H7l-1.5-3.2V6.2L7 3Z"></path><path d="M5.6 7h12.8M5.6 17h12.8"></path><path d="M12 10.2s2.1 2.2 2.1 3.8a2.1 2.1 0 0 1-4.2 0c0-1.6 2.1-3.8 2.1-3.8Z"></path></svg>',
